                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <a href="<?= base_url() ?>/logout" class="btn btn-warning btn-block"><b>Logout</b></a>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="<?= session()->getFlashdata('tag') == 'upassword' ? 'active' : '' ?> tab-pane" id="upassword">
                                    <form class="form-horizontal" id="formUbahPassUser" action="<?= base_url() ?>/profile-edit-password" method="POST">
                                        <input type="hidden" name="id_user" value="<?= $user['id'] ?>">
                                        <div class="form-group row">
